            ...
            <div className="soberDate">
                ...
                { !soberDate || editSoberDate ? (
                    ...
                    <div className="soberDate__soberStats--soberDate">
                        Your sobriety date: <strong>{ `${soberDate?.substr(0, 3)} ${soberDate?.substr(8, 3)} ${soberDate?.substr(5, 2)}, ${soberDate?.substr(12, 4)}` }</strong>
                    </div>
                    ...
                    <div className="soberDate__soberStats--sober-months">
                        <strong>{ addCommaToString((years * 12).toFixed(2)) }</strong> Months
                    </div>
